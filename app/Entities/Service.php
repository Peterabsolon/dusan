...
class Service extends Model
{
    ...
    {
        return $this->hasMany('App\Entities\Price')->where('position', 'left');
    }
    ...
    {
        return $this->hasMany('App\Entities\Price')->where('position', 'right');
    }
    ...
    {
        return $this->hasMany('App\Entities\Package');
    }
}
